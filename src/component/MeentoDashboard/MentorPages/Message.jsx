              ...
              filteredConversations.map((conv) => {
                ...
                return (
                  <div
                    ...
                    className={`flex items-center p-4 cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 ${selectedConversation?._id === conv._id ? 'bg-gray-100 dark:bg-gray-800' : ''}`}
                  >
                    <div className="relative">
                      <img
            ...
            <>
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4">
                {messages.map((message) => (
                  ...
                  >
                    <div className={`relative group max-w-[70%] ${message.sender._id === user._id ? 'ml-auto' : 'mr-auto'}`}>
                      <div
                      ...
                      {showMessageMenu === message._id && (
                        <div className={`absolute mt-2 w-48 bg-white dark:bg-gray-800 rounded-lg shadow-lg z-10 ${message.sender._id === user._id ? 'right-0' : 'left-0'}`}>
                          <button
                            onClick={() => {
                              setReplyTo(message);
                              setShowMessageMenu(null);
