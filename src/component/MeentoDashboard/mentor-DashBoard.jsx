...
function MentorDashBoard() {
    ...
    return (
         <main className='flex bg-white sidebar h-full'>
            <div className={`${toggleState ? 'translate-x-0' : 'translate-x-full'} transition-transform duration-300 fixed flex  justify-end h-screen lg:hidden z-50 top-0  w-full`}>
                <NavRes/>
            </div>
